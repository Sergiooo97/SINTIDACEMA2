...
<body>
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td>{{ $materiales->numero_orden }}</td>
                <td>{{ $materiales->lugar_entrega }}</td>
                <td>{{ $materiales->id_partida }}</td>
                <td>{{ $materiales->N_partida }}</td>
                <td>{{ $materiales->cantidad }}</td>
                <td>{{ $materiales->unidad }}</td>
                <td>{{ $materiales->grupos }}</td>
                <td>{{ $materiales->partes }}</td>
                <td>{{ $materiales->descripcion }}</td>
                <td>{{ $materiales->fecha_entrada }}</td>
                <td>{{ $materiales->fecha_salida }}</td>
                <td>{{ $materiales->precio }}</td>
                <td>{{ $materiales->importe }}</td>
            </tr>
        </tbody>
    </table>
</body>
