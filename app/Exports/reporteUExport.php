...
class reporteUExport implements  FromView, WithDrawings, WithTitle,  WithEvents, ShouldAutoSize
{
    ...
    public function view(): View {
        ...
        return view("exports.excel.reporte_individual",compact("materiales"));
    }
